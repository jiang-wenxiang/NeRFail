...
class MySimpleDataset(Dataset):
    def __init__(self, root: Path, class_names_path: Path = None, test_dir_change_dict: dict = None, ori_img_from: dict=None,
        ...
        for class_name in self.classes:
            self.read_data_from_one_class(class_name)

        self.length = len(self.img_set)

    def read_data_from_one_class(self, class_name: str):
