...
def get_test_dir_after_nerf_attack(scene_name = "lego", model_name = "vgg16", now_class_idx = 10, attack_epochs = 100,
    ...
    if method_name == "NeRFail":
        ...
        test_dir = './output/'+model_name+'/'+step_name+'/' + scene_name + '/no_attack/{}'.format(setname)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--from_dir', type=int, default=32)
    ...
    copy_list = ['train', 'test', 'val', '200000.tar', 'args.txt', 'config.txt']
    ...
    for copy_dir_name in copy_list:
        move_files(args.from_dir + '/' + copy_dir_name, copy_to_dir_path + '/' + copy_dir_name)
